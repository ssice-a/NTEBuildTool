...
- **Mesh Mod Workspace**: The user-facing editor workflow centered on one selected mesh. It presents material slots, texture replacement, Toggle Items, generated runtime assets, and Package Plan candidates in terms of the selected mesh instead of asking the user to type package paths or JSON filenames. It is an orchestration interface over the material module, toggle-runtime module, and package pipeline module, not a place for their implementations.
